...
namespace Otobüsrojesi
{
    public partial class Form9 : Form
    {
        ...
        SqlConnection baglantı = new SqlConnection("Data Source=;Initial Catalog=otobüsdata;Integrated Security=True");
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //bağladığımız vetirabanına gerekli yerlere girdiğimiz bilgileri ekliyoruz.
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            richTextBox_ileti.Clear();
            richTextBox_adres.Clear();
            richTextBox_konu.Clear();
        }
    }
}
