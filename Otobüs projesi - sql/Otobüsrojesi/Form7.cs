...
namespace Otobüsrojesi
{
    public partial class Form7 : Form
    {
        ...
        private void button_kaydet_Click(object sender, EventArgs e)
        {
            ...
            //satın aldığımız kişinin kayıt olarak girilen yerlerini güncelletip ekliyoruz.
        ...
        private void comboBox_nereye_SelectedIndexChanged(object sender, EventArgs e)
            //seçilen illere göre fiyatlarını ekletiyoruz.
        {
        ...
        private void comboBox_adet_Enter(object sender, EventArgs e)
       
         {
                if (textBox_tc.Text == "Tek Bilet Alabilirsiniz")
                {
                    textBox_tc.Text = "";
        ...
        private void comboBox_adet_Leave(object sender, EventArgs e)
        {
            if (textBox_tc.Text == "")
            {
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            ...
            //başlangıçta vt de tablomuzdan hangi kullanıcı işlem yapıyorsa bazı bilgilerini getiriyoruz.
            SqlDataReader oku = komut.ExecuteReader();
            while (oku.Read())
            {
                //getirdiğimiz bağlantıdaki bilgileri yerleştiriyoruz.
