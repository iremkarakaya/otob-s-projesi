...
using System.Collections;//liste oluşturmak için bu kütüphameyi ekliyoruz.
...
namespace Otobüsrojesi
{
    public partial class Form8 : Form
    {
        ...
        //sql ile bağlantımızı oluşturuyoruz. 
        ...
        private void button_koltuksec_Click(object sender, EventArgs e)
        {
            ...
            //koltuğumuzu seçince tablomuzda o kısmı güncelliyoruz.
        ...
        { 
                ...
                //hangi koltuk seçildi ise diğerleri seçilememesi için kapatıyoruz.
                    if (koltuk == 1)
                    {
                        button_sira1.Enabled = false;
                    }
